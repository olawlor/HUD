...
glasses_frame=4.1; // diameter of thickest part of frame
...
glasses_center=[glasses_thick_in-glasses_thick/2,0,phone_above-20];
...
module spaceframe() 
{
    ...
    framepoints=[
        [support_x,-50,2], // back temple
        [support_x+5,-20,20], // low forehead
        [support_x+60,-40,35], // high forehead
        [support_x,0,0], // front glasses frame
        [support_x+80,-20,0] // top diagonal brace
    ];
    ...
    difference() {
        union() {
            ...
            difference() {
                ...
                translate([phone_above*0.4,15,0])
                    scale([2,1,1])
